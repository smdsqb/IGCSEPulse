...
export default function TextbooksPage() {
  const totalFiles = textbooksData.subjects.reduce((acc, s) => acc + s.files.length, 0);
    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRow}>
            <div>
              ...
              <h1>📘 Textbooks</h1>
              <p>Cambridge IGCSE textbooks organised by subject. Updated regularly.</p>
            </div>
            <div className={styles.stats}>
              ...
              <div className={styles.stat}>
                <div className={styles.statNum}>{textbooksData.subjects.length}</div>
        ...
        <div className={styles.subjects}>
          {textbooksData.subjects.map((subject) => (
        ...
        <div className={styles.updatedNote}>
          Last updated: {textbooksData.lastUpdated}
        </div>
      </main>
      <Footer />
    </>
