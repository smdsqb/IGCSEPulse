...
export default function CommunityPage() {
  ...
  async function sendAIReply(question: string) {
    ...
    try {
      const res = await fetch("/api/chat", {
        ...
        body: JSON.stringify({
          question,
          subject: toApiSubject(activeSubject),
          marks: null,
          userId: user.uid,
          sessionId: "community",
          history: [],
      ...
      // data.reply is already stripped of metadata by the API route
      const answer = (data.reply ?? "Sorry, I couldn't answer that.").trim();
  ...
  async function toggleReaction(msgId: string, emoji: string) {
    ...
    // Keep quick emoji bar open after reacting — only close full picker
    setFullEmojiFor(null);
  }
